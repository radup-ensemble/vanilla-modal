    ...
    fetch("https://" + this.baseUrl + "/console/services/ims/organizations/" + this.config.orgId + "/terms", {
      ...
      res.json().then(response => {
        if (!response.accepted || !response.current) {
          ...
          document.body.innerHTML += '<div class="modal" id="dev-modal">\n'
              ...
              + '                <b>'+ this.config.email +'</b> in <b>'+ this.config.orgName +'</b> organization and\n'
    ...
    fetch("https://" + this.baseUrl + "/console/services/ims/organizations/" + this.config.orgId + "/terms", {
      ...
      res.json().then(response => {
        if (response.accepted) {
          ...
          alert('There was an error when trying to accept dev terms for org ' + this.config.orgId);
        }
      });
    });
  }
